						...
						{this.props.content.preInfo == undefined
							...
							: (<View style={styles.subinfo.preInfo}>
								<Text style={styles.text.content}>
									...
									<StaticText property={this.props.content.preInfo[3]} style={styles.text.bold} />
									<StaticText property={this.props.content.preInfo[4]} />
								</Text>
							</View>)

						}
						{this.props.content.term === undefined ? null : (
							<View style={styles.subinfo.term}>
								<StaticText property={this.props.content.term[0]} style={styles.text.content} />
								<StaticText property={this.props.content.term[1]} style={styles.text.content} />
								<StaticText property={this.props.content.term[2]} style={styles.text.content} />
								<StaticText property={this.props.content.term[3]} style={styles.text.content} />
							</View>
						)}

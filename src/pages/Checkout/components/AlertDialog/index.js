                ...
                <View style={styles.container}>
                    <View style={styles.subcontainer.box}>
                        <View style={styles.subcontainer.text}>
                            <Text style={styles.text.static}>
                                <StaticText
                                    property={this.props.content}
                                />
                                {this.props.subcontent.map(content => {
                                    if(content.primary === 1) {
                                        return `${content.address}, Kelurahan ${content.zip_code.place_name}, Kecamatan ${content.subdistrict.name} Kota ${content.city.name}, ${content.province.name}, ${content.zip_code.zip_code}`
                                    }
                                })}
                            </Text>
                        </View>
